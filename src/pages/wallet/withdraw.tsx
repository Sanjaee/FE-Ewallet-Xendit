...
export default function Withdraw() {
  ...
  const [withdrawDetails, setWithdrawDetails] =
    useState<WithdrawDetails | null>(null);
  ...
  const handleWithdraw = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          apiError.response?.data?.error || "Failed to process your withdrawal",
        variant: "destructive",
      });
      setConfirmOpen(false);
    } finally {
            ...
            <div className="space-y-4 py-4">
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  Rp {withdrawDetails.amount.toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Fee (1%):</span>
                <span className="font-medium">
                  Rp {withdrawDetails.fee.toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between border-t pt-2">
                ...
                <span className="font-bold">
                  Rp {withdrawDetails.actualAmount.toLocaleString()}
                </span>
              </div>
              <div className="border-t pt-4 mt-4">
                ...
                <div className="mt-2">
                  ...
                  <p>
                    ...
                    {withdrawDetails.accountHolderName}
                  </p>
                </div>
              </div>
            </div>
