        ...
        <>
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>Manage your e-wallet</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="bg-primary/10 p-6 rounded-lg">
                <p className="text-sm text-muted-foreground">Current Balance</p>
                <h2 className="text-4xl font-bold">Rp {balance.toLocaleString()}</h2>
              </div>
            </CardContent>
            <CardFooter className="flex justify-between">
              <Button onClick={() => router.push('/wallet/topup')}>Top Up</Button>
              <Button onClick={() => router.push('/wallet/transfer')}>Transfer</Button>
              <Button onClick={() => router.push('/wallet/withdraw')}>Withdraw</Button>
            </CardFooter>
          </Card>
                    ...
                    <div key={transaction.id} className="flex justify-between items-center border-b pb-2">
                      ...
                      <div className={`font-semibold ${
                        transaction.type === 'TOPUP' 
                          ? 'text-green-600' 
                          : transaction.type === 'WITHDRAW' || transaction.type === 'TRANSFER' || transaction.type === 'FEE'
                            ? 'text-red-600' 
                            : ''
                      }`}>
                        {transaction.type === 'TOPUP' 
